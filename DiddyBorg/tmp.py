...
q = ax.quiver(x[:end_index:skip, 0], x[:end_index:skip, 1], -np.sin(x[:end_index:skip, 2]),
              np.cos(x[:end_index:skip, 2]), headwidth=1, width=0.0051, alpha=0.8, color='blue')
...
print('xhat_history_GN[:, -1] ',xhat_history_GN[:, -1])